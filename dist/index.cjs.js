...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$v, { color: "text", ml: "4px" })));
};
...
var links = [
    ...
    },
    {
        ...
        icon: "ShieldIcon",
        href: "https://twitter.com/PaddySwapDeFi/status/1367218225310818308",
        target: "_blank",
    },
    {
        label: "Bush",
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/PaddySwapFinance/",
                target: '_blank',
            },
            {
                label: "Docs",
                href: "https://PaddySwapFinance.gitbook.io/paddyswap/",
            },
            {
                label: "Blog",
                href: "https://paddyswap.medium.com/",
            },
        ],
    },
];
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/PaddySwapDeFi",
        color: "#55A9E0",
        colorDark: "#55A9E0"
    },
    {
        label: "Discord",
        icon: "DiscordIcon",
        href: "https://discord.gg/JRBC2UfS9k",
        color: "#8899F7",
        colorDark: "#8899F7"
    },
    {
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://dex.guru/token/0x899C3aAe9812e7b38464B9CA1260c1C0901D2190-bsc", target: "_blank" },
...
var SocialLinks = function () {
    ...
    return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
        ...
        var iconProps = { width: "24px", style: { cursor: "pointer" } };
        ...
        return (React__default['default'].createElement(Link, { external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr },
            React__default['default'].createElement(Icon, __assign({}, iconProps, { style: { fill: theme.isDark ? social.colorDark : social.color } }))));
    })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#F6F6F7", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", title: "#41aa29", text: "#1B1464", textDisabled: "#BDC2C4", textSubtle: "#1B1464", borderColor: "#E9EAEB", card: "#FFFFFF", nav: "#f9fdf9", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#52D784", background: "#1F2B46", backgroundDisabled: "#424037", contrast: "#FFFFFF", invertedContrast: "#262513", input: "#483F5A", primaryDark: "#8f8104", tertiary: "#28444A", title: "#41aa29", text: "#fcfae2", textDisabled: "#717161", textSubtle: "#52D784", borderColor: "#61634b", card: "#0D0F22", nav: "#0D0F22", gradients: {
